...
totals <- data.frame(Lake=c("Lake Superior", "Lake Erie", "Lake Huron", "Lake Ontario", "Lake Michigan"), 
                     Score=c(mean(superior$scores[!is.na(superior$scores)]), mean(erie$scores[!is.na(superior$scores)]), 
